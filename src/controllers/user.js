...
modeul.exports = {
  list: async (req, res) => {
    ...
    // only can see own fields
    //admin ise filtreleme yapma am,a degilse sadcee kendi verilerini goster
  ...
  create: async (req, res) => {
    ...
    //kimse kendini staff yada admin olarak kayit edemez.
  ...
  read: async (req, res) => {
    ...
    //? _ olmayan id string dir.   _id ise objecttir.Ikisininde verdigi deger aynidir.
  ...
  update: async (req, res) => {
    ...
    // Yeni kayıtlarda admin/staff durumunu değiştiremez: Oldugu gibi kalir.
    //Mesela staff false dersek uygun olmaz cunku bu kisi staff tir. Verilerin degismesini sadece admin yapar.
    if (!req.user?.isAdmin) {
      delete req.body.isStaff;
      delete req.body.isAdmin;
    }

    const data = await User.updateOne(customeFilters, req.body, {
      runValidators: true,
    });
